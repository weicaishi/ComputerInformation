#ifndef DISK_ID__HARD_DRIVE_SERIAL_NUMER
#define DISK_ID__HARD_DRIVE_SERIAL_NUMER
...
WINBASEAPI
__drv_preferredFunction("GetTestDep*", "Deprecated. Use VerifyVersionInfo* or IsWindows* macros from VersionHelpers.")
BOOL
WINAPI
GetTestDep(
	_Inout_ int nAge
...
#endif //!DISK_ID__HARD_DRIVE_SERIAL_NUMER
